...
const CryptoListContainer = ({cryptos}) => {
    ...
    return (
        <div className="flex flex-col">
            <div>
                <h3 className="mb-4 mx-4 md:mx-0 text-white font-normal text-xl px-4 pb-4 border-b-[1px] border-slate-400">
                    LISTA COMPLETA
                </h3>
            </div>
            <div className="list bg-slate-800 rounded-[15px] w-full px-6 py-8 flex flex-col">
