...
const SideBar = () => {
    return (
        <aside className="h-14 w-screen fixed top-0 left-0 px-6 z-40 bg-slate-800 rounded-b-[20px] flex items-center md:w-40 md:h-screen md:px-0 md:pr-6 md:rounded-r-[20px]">
