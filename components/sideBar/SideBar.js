...
const SideBar = () => {
    return (
        <aside className="h-14 w-screen fixed top-0 left-0 px-6 z-40 bg-slate-800 flex items-center md:w-40 md:h-full md:px-0 md:pr-6 md:rounded-r-[20px] border-b-2 md:rounded-bl-none md:border-r-2 md:border-b-0 border-yellow-600">
